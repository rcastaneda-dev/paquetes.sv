...
import { buildZapatosFlatRows } from '@/lib/reports/editable-v2';

const FILENAME = 'Zapatos_Acumulado_Editable_V2.xlsx';
const PAGE_SIZE = 1000;
const MAX_ROWS = 200000;

/**
 * GET /api/bulk/jobs/[jobId]/zapatos-pivot-excel-v2
 *
...
export async function GET(_request: Request, { params }: { params: { jobId: string } }) {
  ...
  try {
    ...
    const flatRows = buildZapatosFlatRows(schools);
    ...
    console.error('Error in zapatos-pivot-excel-v2:', error);
