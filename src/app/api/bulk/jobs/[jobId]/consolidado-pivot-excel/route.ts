...
import { generateConsolidadoPivotExcel, EXCEL_FILENAMES } from '@/lib/excel/generators';

export const dynamic = 'force-dynamic';

const FILENAME = EXCEL_FILENAMES.consolidadoPivot;
...
export async function GET(_request: Request, { params }: { params: { jobId: string } }) {
  ...
  try {
    ...
    const buffer = await generateConsolidadoPivotExcel(allStudents);
