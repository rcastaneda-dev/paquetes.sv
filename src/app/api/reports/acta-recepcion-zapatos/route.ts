...
import { generateActaRecepcionZapatosPDF } from '@/lib/pdf/generator';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const pdfStream = generateActaRecepcionZapatosPDF({
      fechaInicio,
      students,
    });
    ...
    const fileName = `acta-recepcion-zapatos-${slugify(school.nombre_ce)}-${slugify(gradoLabel)}.pdf`;
    ...
    console.error('Error generating Acta Recepción Zapatos PDF:', error);
