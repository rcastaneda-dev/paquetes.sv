-- ========================================================================
-- Migration: Add transporte field to query_students return type
-- ========================================================================
-- This migration updates the query_students function to include the
-- transporte field from the schools table for PDF generation.
-- ========================================================================
...
COMMENT ON FUNCTION public.query_students IS 'Returns students with their school and uniform information, including transporte field for PDF generation. Supports filtering by school, grade, department, and fecha_inicio for efficient bulk report generation.';
