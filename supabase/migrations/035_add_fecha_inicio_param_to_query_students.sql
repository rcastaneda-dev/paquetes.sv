-- ========================================================================
-- Migration: Add optional p_fecha_inicio parameter to query_students
-- ========================================================================
-- This migration adds a new optional parameter to filter students by
-- fecha_inicio at the database level, improving performance for bulk
-- category report generation.
--
-- Backward compatibility: The function signature is extended, so existing
-- calls without p_fecha_inicio will continue to work (defaults to NULL).
-- ========================================================================

DROP FUNCTION IF EXISTS public.query_students(TEXT, TEXT, TEXT, INTEGER, INTEGER);
...
COMMENT ON FUNCTION public.query_students IS 'Returns students with their school and uniform information. Supports filtering by school, grade, department, and fecha_inicio for efficient bulk report generation.';
